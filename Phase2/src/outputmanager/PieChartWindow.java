...
public class PieChartWindow {
	...
	private void createObjectDataset(Taxpayer taxpayer) {
		taxpayer.calculateSums();
		objectDataset.setValue("Entertainment",
				taxpayer.getReceiptsSum("Entertainment"));
		objectDataset.setValue("Basic", taxpayer.getReceiptsSum("Basic"));
		objectDataset.setValue("Travel", taxpayer.getReceiptsSum("Travel"));
		objectDataset.setValue("Health", taxpayer.getReceiptsSum("Health"));
		objectDataset.setValue("Other", taxpayer.getReceiptsSum("Other"));
	}
	...
	private void showPieChartFrame() {
		pieChartFrame.setModalExclusionType(
