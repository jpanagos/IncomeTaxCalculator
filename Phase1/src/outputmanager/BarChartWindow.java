...
public class BarChartWindow {
	...
	private void createObjectDataset(Taxpayer taxpayer) {
		objectDataset.setValue(taxpayer.getBasicTax(), taxpayer.getFullName(), "Basic Tax");
		objectDataset.setValue(taxpayer.getTaxIncrease(), taxpayer.getFullName(), "Tax Increase");
		objectDataset.setValue(taxpayer.getTotalTax(), taxpayer.getFullName(), "Total Tax");
	}
	...
	private void showBarChartFrame() {
		barChartFrame.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
		barChartFrame.pack();
